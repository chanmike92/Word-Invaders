...
class Game {
  ...
  handleSubmit() {
    ...
    const eventListener = (e) => {
      e.preventDefault();
      if (typeof this.board.fallingWords[inputBox.value] === 'undefined') {
        debugger
        e.preventDefault();
      } else {
        debugger
        this.board.removeWord(inputBox.value);
      }
    };
    inputForm.addEventListener('submit', eventListener);
  }
